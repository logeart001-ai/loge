...
('11111111-1111-1111-1111-111111111111', 'Ancestral Echoes', 'A vibrant mixed media piece exploring the connection between past and present through traditional Yoruba symbols', 'art_design', 150000, 200000, '/placeholder.svg?height=400&width=400&text=Ancestral+Echoes', true, true, ARRAY['traditional', 'mixed-media', 'yoruba', 'contemporary']),
('11111111-1111-1111-1111-111111111111', 'Urban Rhythms', 'Digital art piece capturing the energy of Lagos street life with bold colors and geometric patterns', 'art_design', 75000, null, '/placeholder.svg?height=400&width=400&text=Urban+Rhythms', true, true, ARRAY['digital', 'urban', 'geometric', 'lagos']),
('22222222-2222-2222-2222-222222222222', 'Resilience', 'Bronze sculpture made from recycled materials, representing the strength of the African spirit', 'sculpture', 500000, null, '/placeholder.svg?height=400&width=400&text=Resilience', true, true, ARRAY['bronze', 'recycled', 'sculpture', 'strength']),
('22222222-2222-2222-2222-222222222222', 'Mother Earth', 'Clay sculpture celebrating the nurturing power of nature and femininity', 'sculpture', 250000, 300000, '/placeholder.svg?height=400&width=400&text=Mother+Earth', false, true, ARRAY['clay', 'nature', 'feminine', 'earth']),
('33333333-3333-3333-3333-333333333333', 'Kente Dreams Dress', 'Modern midi dress featuring authentic Kente cloth patterns with contemporary tailoring', 'fashion', 85000, null, '/placeholder.svg?height=400&width=400&text=Kente+Dreams', true, true, ARRAY['kente', 'dress', 'traditional', 'modern']),
('33333333-3333-3333-3333-333333333333', 'Ankara Blazer', 'Professional blazer in bold Ankara print, perfect for the modern African woman', 'fashion', 65000, 80000, '/placeholder.svg?height=400&width=400&text=Ankara+Blazer', true, true, ARRAY['ankara', 'blazer', 'professional', 'bold']);
