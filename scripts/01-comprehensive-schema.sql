...
CREATE TABLE creator_applications (
  ...
  application_data JSONB NOT NULL, -- Portfolio, experience, etc.
...
CREATE INDEX idx_user_profiles_search ON user_profiles USING GIN(to_tsvector('english', full_name || ' ' || COALESCE(bio, '')));
