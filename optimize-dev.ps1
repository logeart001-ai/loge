...
if ($currentPath -like "*OneDrive*") {
    ...
    Write-Host "   Consider moving to: C:\Projects\loge" -ForegroundColor Yellow
    Write-Host ""
}
...
Write-Host "   3. Test navigation speed" -ForegroundColor White
Write-Host ""
...
Write-Host "   • Close unnecessary programs" -ForegroundColor White
Write-Host ""

Write-Host "📚 Read PERFORMANCE_OPTIMIZATION_GUIDE.md for more tips" -ForegroundColor Cyan
Write-Host ""