...
export default function FashionPage() {
  ...
  const fashionItems = [
    ...
    },
    {
      ...
      price: 28000,
      image: '/placeholder.svg?height=400&width=300&text=Dashiki+Shirt',
      category: 'Shirts',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    ...
    },
    {
      ...
      price: 35000,
      image: '/placeholder.svg?height=400&width=300&text=Adire+Skirt',
      category: 'Skirts',
      sizes: ['XS', 'S', 'M', 'L'],
    ...
    },
    {
      ...
      price: 85000,
      image: '/placeholder.svg?height=400&width=300&text=Bogolan+Jacket',
      category: 'Jackets',
      sizes: ['M', 'L', 'XL'],
